...
public class FarmerState extends State {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 31 * hash + Objects.hashCode(this.farmer);
        hash = 31 * hash + Objects.hashCode(this.wolf);
        hash = 31 * hash + Objects.hashCode(this.goat);
        hash = 31 * hash + Objects.hashCode(this.cabbage);
        return hash;
    }
