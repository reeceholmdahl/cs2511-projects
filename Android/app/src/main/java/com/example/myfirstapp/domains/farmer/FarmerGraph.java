...
import com.example.myfirstapp.framework.graph.Graph;
import com.example.myfirstapp.framework.graph.Vertex;

public class FarmerGraph extends Graph {
    
    public static final Vertex v1 = new Vertex(new FarmerState("West", "West", "West", "West"));
    ...
    public static final Vertex v6 = new Vertex(new FarmerState("East", "East", "East", "East"));
    public static final Vertex v7 = new Vertex(new FarmerState("East", "West", "East", "West"));
    public static final Vertex v8 = new Vertex(new FarmerState("East", "West", "East", "East"));
    public static final Vertex v9 = new Vertex(new FarmerState("East", "East", "West", "East"));
