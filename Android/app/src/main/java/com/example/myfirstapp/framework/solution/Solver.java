...
import static com.example.myfirstapp.framework.solution.Statistics.CIRCULARITIES;
import static com.example.myfirstapp.framework.solution.Statistics.LENGTH;
import static com.example.myfirstapp.framework.solution.Statistics.NUM_OPS;
import static com.example.myfirstapp.framework.solution.Statistics.QUEUE_SIZE;
import static com.example.myfirstapp.framework.solution.Statistics.TIME;
import static com.example.myfirstapp.framework.solution.Statistics.VERTICES;
...
public abstract class Solver {
    ...
    private Vertex search(Vertex s) {
        ...
        Vertex finalState = new Vertex(problem.getFinalState());
        ...
        while (!queue.isEmpty()) {
            ...
            if (u.equals(finalState)) {
                return u;
            }
            
            expand(u).stream().filter((v) -> (!vertices.containsKey(v))).forEachOrdered((v) -> {
                vertices.put(v, v);
